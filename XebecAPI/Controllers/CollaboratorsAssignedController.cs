...
namespace XebecAPI.Controllers
{
    ...
    public class CollaboratorsAssignedController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCollaboratorsAssigned()
        {
            try
            {
                var collaboratorsAssigned = await _unitOfWork.CollaboratorsAssigneds.GetAll();
        ...
        public async Task<IActionResult> GetCollaboratorsAssigned(int id)
        {
            try
            {
                var collaboratorsAssigned = await _unitOfWork.CollaboratorsAssigneds.GetT(q => q.Id == id);
                return Ok(collaboratorsAssigned);
            }
            catch (Exception e)
            {
        ...
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<IActionResult> CreateCollaboratorsAssigned([FromBody] CollaboratorsAssigned collaboratorsAssigned)
        {
            ...
            try
            {
                ...
                await _unitOfWork.CollaboratorsAssigneds.Insert(collaboratorsAssigned);
        ...
        public async Task<IActionResult> UpdateCollaboratorsAssigned(int id, [FromBody] CollaboratorsAssignedDTO collaboratorsAssigned)
        {
            ...
            try
            {
                var originalAdditionalInformation = await _unitOfWork.CollaboratorsAssigneds.GetT(q => q.Id == id);
                ...
                _unitOfWork.CollaboratorsAssigneds.Update(originalAdditionalInformation);
                await _unitOfWork.Save();
        ...
        public async Task<IActionResult> DeleteCollaboratorsAssigned(int id)
        {
            ...
            try
            {
                var AdditionalInformation = await _unitOfWork.CollaboratorsAssigneds.GetT(q => q.Id == id);
